...
# REQUISITO ATENDIDO: Definição aleatória de usuários e modelos
USUARIOS = ['Alice', 'José', 'Carol', 'Daniel']
MODELOS = ['Dados/H-1.csv', 'Dados/H-2.csv']  # 60x60 e 30x30
...
def enviar_sinal():
    """
    REQUISITO ATENDIDO: Envia sinal para reconstrução com parâmetros aleatórios
    """
